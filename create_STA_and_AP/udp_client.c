...
void receive_csi_cb(void *ctx, wifi_csi_info_t *data) 
{
	...
	{	
		...
		if(strcmp(senddMacChr, "24:0A:C4:0C:4F:35") == 0)
		{
			while(can_print == 0){}
...
void promi_cb(void *buff, wifi_promiscuous_pkt_type_t type) 
{
	...
	if(strcmp(senddMacChr, "24:0A:C4:0C:4F:35") == 0 && strcmp(recvdMacChr, "24:0A:C4:11:A5:74") == 0) 
	{
		while (can_print == 0){}
		can_print = 0;
...
static void udp_client_task(void)
{
    ...
    while (1) 
	{
        ...
        while (1) 
		{
            ...
            vTaskDelay(5000 / portTICK_PERIOD_MS); // time between packets in milliseconds
        }
